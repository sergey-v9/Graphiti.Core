...
public class PackageReadinessTests
{
    ...
    public void TestDependencies_UseCurrentPackagesAndDoNotCarryUnusedVersions()
    {
        ...
        Assert.Equal("0.19.1-dev.26.1.eng-554c1e711", packageVersionsById["LadybugDB"]);
        Assert.Equal("0.19.1-dev.26.1.eng-554c1e711", packageVersionsById["LadybugDB.Native"]);
