...
public class GraphitiWorkflowTests
{
    ...
    public async Task AddTriplet_EdgeUuidCollisionWithNonEntityEdgePreservesUuidLikePython()
    {
        ...
        var alice = new EntityNode { Uuid = "entity-alice", Name = "Alice", GroupId = "group", CreatedAt = now };
        var bob = new EntityNode { Uuid = "entity-bob", Name = "Bob", GroupId = "group", CreatedAt = now };
        ...
        var collidingEntityEdge = new EntityEdge
        {
            Uuid = mention.Uuid,
            SourceNodeUuid = alice.Uuid,
            TargetNodeUuid = bob.Uuid,
    ...
    public async Task AddEpisodeBulk_DoesNotFinalBulkSaveAfterExtractionFailure()
    {
        ...
        await Assert.ThrowsAsync<GroupsEdgesNotFoundException>(() =>
            EntityEdge.GetByGroupIdsAsync(driver, new[] { "group" }));
        await Assert.ThrowsAsync<GroupsEdgesNotFoundException>(() =>
