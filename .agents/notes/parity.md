...
| `d9a2db9` provider/search consolidation | ADOPTED / N/A | Scoped community cleanup is adopted; shared edge projection/BFS behavior was already aligned; FalkorDB full-text mechanics are N/A |
