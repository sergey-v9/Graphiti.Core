...
focused filter covering L2 normalization helpers and downstream MMR vector scoring. It ran locked
restore, 9 focused cases, format verification, no-incremental build, the full test suite (`870`
