...
focused filter covering content covering-chunk generation. It ran locked restore, 12 focused cases,
format verification, no-incremental build, the full test suite (`868` passed), and `dotnet pack` for
