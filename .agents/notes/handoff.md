...
focused filter covering reusable cosine-similarity scoring. It ran locked restore, 2 focused cases,
format verification, no-incremental build, the full test suite (`870` passed), and `dotnet pack` for
