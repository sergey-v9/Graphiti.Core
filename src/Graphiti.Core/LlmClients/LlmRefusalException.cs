...
/// finish reason). This is surfaced to the caller and is NOT retried by <see cref="LlmClient"/>'s
/// validation-retry loop, which only re-prompts on <see cref="System.Text.Json.JsonException"/>.
/// </summary>
