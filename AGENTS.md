...
Verified on 2026-06-01 after the community clustering allocation/parity slice:
locked restore, format verification, and no-incremental build succeeded with 0 warnings, 860 tests
