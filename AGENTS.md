...
Verified on 2026-06-01 after the content chunking splitter allocation slice:
locked restore, format verification, and no-incremental build succeeded with 0 warnings, 863 tests
