...
Verified on 2026-06-01 after the content chunking JSON/covering allocation slice:
locked restore, format verification, and no-incremental build succeeded with 0 warnings, 861 tests
