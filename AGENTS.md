...
Verified on 2026-06-01 after the episode removal/saga repair allocation/parity slice:
locked restore, format verification, and no-incremental build succeeded with 0 warnings, 858 tests
