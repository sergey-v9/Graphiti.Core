...
Verified on 2026-06-01 after the shared concurrency helper allocation slice:
locked restore, format verification, and no-incremental build succeeded with 0 warnings, 864 tests
